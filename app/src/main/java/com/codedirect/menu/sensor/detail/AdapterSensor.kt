...
class AdapterSensor (val dataItems: ArrayList<DataModel?>?,
                     private val listener: (DataModel?) -> Unit): RecyclerView.Adapter<AdapterSensor.itemHolder>(){

    override fun onCreateViewHolder(parent: ViewGroup, position: Int): itemHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.item_sensor,parent,false)
